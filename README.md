...
## Run Pipeline
    ...
    --year 2025 
    python scripts/01_prepare_aoi_raw.py --aoi auroville --year
    2025 
    python scripts/02_build_stack.py --aoi auroville --year 2025
...
## Deep Learning
    ...
    --stride 32 --clean 
    python -m scripts.dl.train_unet --aoi auroville
    --year 2025 
    python -m scripts.dl.predict_unet --aoi auroville --year
    2025 --threshold 0.35
